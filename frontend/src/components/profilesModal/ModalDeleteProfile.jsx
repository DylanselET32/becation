...
export default function ModalDeleteProfile(props) {
    ...
    return (
        <>
            ...
            {errorMessage && (
                ...
                <p>Estas seguro que deseas eliminar al empleado "<span className="text-nowrap fw-bold">{props.item.name} {props.item.surname}"</span></p>
